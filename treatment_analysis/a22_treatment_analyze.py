...
for ii,file in enumerate(image_files[:]):
   ...
   # phase_img = image[0]
    ...
    for kk, cell in enumerate(cells[:]):
        ...
        store_data.append((sample, t / 60, cell_label, condensation_coeff[0], 
...
df.columns = ['Sample', 'Time (h)', 'Cell Label', 'I = 0.1',
